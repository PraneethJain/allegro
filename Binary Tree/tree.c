...
const float thickness_factor = 0.825;
...
void draw_line(int x, int y, float length, float angle, float thickness, int level)
{
    ...
    al_draw_line(x, y, end_x, end_y, level <= 10 ? al_map_rgb(97, 59, 22) : al_map_rgb(12, 174, 91), thickness);
...
void rec_drawing()
{
    draw_line(WIDTH / 2, HEIGHT, 150, 0, 9, 0);
}
